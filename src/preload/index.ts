...
const api = {
  ...
  setOllamaActiveModel: (modelName: string) => ipcRenderer.invoke('set-ollama-active-model', modelName),
  deleteOllamaModel: (targetModel?: string) => ipcRenderer.invoke('delete-ollama-model', targetModel),
